...
//this.state.accountValue===true?<div><textarea value={this.state.fields["availableBalance"]}>value={this.state.fields["availableBalance"]}</textarea></div>:<textarea value={this.state.fields["availableBalance"]}>value={this.state.fields["availableBalance"]}</textarea>
  }
  <div className="form-group">
       <label htmlFor="availableBalance">available Balance</label>
       <input type="text" className="form-control" name="availableBalance" id="availableBalance" value={this.state.fields["availableBalance"]} ></input>
